-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'PSYCHOLOGIST', 'PSYCHIATRIST', 'THERAPIST', 'SECRETARY');
...
-- AddForeignKey
ALTER TABLE "ConsentTerm" ADD CONSTRAINT "ConsentTerm_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
